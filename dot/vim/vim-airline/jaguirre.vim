...
let s:N1   = [ '#313338' , '#705090' ,  17  , 190, 'bold' ]
let s:N2   = [ '#313338' , '#875faf' , 255 , 238, 'bold' ]
let s:N3   = [ '#DEC5F9' , '#1C3033' , 85  , 234 ]

let s:NM1   = [ '#313338' , '#F97F59' ,  17  , 190, 'bold' ]
let s:NM2   = [ '#313338' , '#875faf' , 255 , 238, 'bold' ]
let s:NM3   = [ '#DEC5F9' , '#1C3033' , 85  , 234 ]

let s:warning_area = ['#2E383C', '#FDB934', 232, 92, 'bold']
...
call airline#parts#define_function('filepath', 'ProjectFilepath')
